...
related:
  - ../orders-types/CLAUDE.md
---

# Entitlements

What money and support each orders type actually rates. The one-look answer is
[entitlements-matrix.md](entitlements-matrix.md); the rest go deeper per topic.

## Pages

- [entitlements-matrix.md](entitlements-matrix.md) — per diem / lodging / rental car / commercial travel by orders type
